...
?>
                            ...
                            <div class="card-body pt-0">
                                <dl class="card-content">
                                    <div class="card-content__row">
                                        ...
                                        <dd><?//= Loc::getMessage("SPOD_SUMMARY") ?> <?= $arResult["PRICE_FORMATED"] ?></dd>
                                    </div>
                                    <div class="card-content__row">
                                        <dt>Количество позиций:</dt>
                                        <dd><?//= $arResult['FULL_QUANTITY'] ?><span id="posCount"></span></dd>
                                    </div>
                                    <div class="card-content__row">
                    ...
                    */?>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <? if ($arResult["PRINT_ORDER_PROPS"]) :
                                    foreach ($arResult["PRINT_ORDER_PROPS"] as $orderGroup) : ?>
                                        ...
                                        <?if($orderGroup["PROPS"][0]["GROUP_NAME"] != 'Контактная информация'):?>
                                            <div class="card-header d-flex flex-wrap" style="margin: 0 -1rem;">
                                                <h6 class="card-title mb-0 fw-bold"><?= $orderGroup["PROPS"][0]["GROUP_NAME"] ?></h6>
                                            </div>
                                            <dl class="card-content">
                                                <div class="card-content__row">
                    ...
                    <? if ($arResult["PRINT_ORDER_PROPS"]) :
                        foreach ($arResult["PRINT_ORDER_PROPS"] as $orderGroup) : ?>
                            ...
                            <?if($orderGroup["PROPS"][0]["GROUP_NAME"] != 'Данные компании' && $orderGroup["PROPS"][0]["GROUP_NAME"] != 'Данные предпринимателя'):?>
                                <div class="card">
                                    <div class="card-header d-flex flex-wrap">
                                        <h6 class="card-title mb-0 fw-bold"><?= $orderGroup["PROPS"][0]["GROUP_NAME"] ?></h6>
                                        <div class="d-inline-flex ms-auto">
    ...
    <script>
        ...
        $(document).ready(function(){
            var posCount = $('#PRODUCT_LIST_bottom_panels .main-grid-panel-content-text').html();
