...
<div class="sotbit_cabinet">
	...
	"ol-feedback", 
	array(
		"COMPONENT_TEMPLATE" => "ol-feedback",
		"EMAIL_TO" => "igory@ak-cent.kz,olesyab@ak-cent.kz,viktor.v@ak-cent.kz,maxim.b@ak-cent.kz,ilyaa@ak-cent.kz,temirlan.s@ak-cent.kz",
