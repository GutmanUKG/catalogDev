	...
	BX.Sale.BasketComponent = {
		...
		bindQuantityEvents: function(node, data)
		{
			...
			if (block)
			{
				...
				// BX.bind(entity, 'click', function(){
				// 	console.log(this);
				// 	if(data.QUANTITY == 0){
				// 		$(this).closest('.basket__item').find('.basket__item-actions-remove[data-entity="basket-item-delete"]').trigger('click');
				// 	}
				// });
		...
		quantityMinus: function(target)
		{
			...
			if (itemData)
			{
				...
				if(quantity == 0){
					$('#basket-item-'+itemData['ID']).closest('.basket__item').find('.basket__item-actions-remove[data-entity="basket-item-delete"]').trigger('click');
				}
