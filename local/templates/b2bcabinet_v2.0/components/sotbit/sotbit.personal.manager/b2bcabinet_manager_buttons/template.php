...
<div class="personal-manager-button fab-menu fab-menu-bottom fab-menu-bottom-end" data-fab-position="custom" data-fab-toggle="click">
    ...
    <ul class="fab-menu-inner">
        <?if(!empty($arResult['WORK_PHONE'])):?>
            <li>
                <div class="fab-label-center" data-fab-label="<?= Loc::getMessage('PERSONAL_MANAGER_PHONE') ?>">
        ...
        <?if(!empty($arResult['UF_P_MANAGER_EMAIL'])):?>
            <li>
                <div class="fab-label-center" data-fab-label="<?= Loc::getMessage('PERSONAL_MANAGER_EMAIL') ?>">
        ...
        <? endif; ?>
        <li>
            <div class="fab-label-center" data-fab-label="<?= Loc::getMessage('PERSONAL_MANAGER_REQUEST_CALL')?>">
