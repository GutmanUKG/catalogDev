...
$buyers = [];
$pt = unserialize(Bitrix\Main\Config\Option::get("sotbit.b2bcabinet","BUYER_PERSONAL_TYPE","a:0:{}"), ['allowed_classes' => false]);
if(!is_array($pt))
{
	$pt = [];
}
...
$orgProps = unserialize(Bitrix\Main\Config\Option::get('sotbit.b2bcabinet', 'PROFILE_ORG_NAME'), ['allowed_classes' => false]);
