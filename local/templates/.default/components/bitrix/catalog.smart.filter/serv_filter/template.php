                ...
                <div class="row items-row">
                    ...
                    foreach($arResult["ITEMS"] as $key=>$arItem)
                    {
                        ...
                        if (
                            ...
                            continue;
                        ?>
                        <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?/*if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif*/?>">
                            <span class="bx-filter-container-modef"></span>
                            ...
                            <div class="bx-filter-block" data-role="bx_filter_block">
                                <div class="row bx-filter-parameters-box-container">
                                    ...
                                    $allValues = [];
                                    $groupedValues = [];
                                    // Собираем все значения и убираем дубликаты
                                    foreach($arItem["VALUES"] as $val => $ar) {
                                        $value = trim($ar["VALUE"]);
                                        if(!in_array($value, $allValues)) {
                                            $allValues[] = $value;
                                            $groupedValues[$value] = $ar;
                                        }
                                    }
                                    ...
                                    $currentLetter = '';
                                    ?>
                                        <div class="col-xs-12 col-grid-2">
                                            <?foreach($groupedValues as $value => $ar):?>
                                                <div>
                                                    <?php
                                                    $firstLetter = mb_strtoupper(mb_substr(trim($value), 0, 1 ), 'UTF-8');
