...
$MESS["WIZARD_METHOD_INSTALL_AS_SITE"] = 'Как отдельный сайт (После установки оптовый кабинет будет доступен по адресу siteХ.ru)';
$MESS["WIZARD_METHOD_INSTALL_AS_TEMPLATE"] = 'Как шаблон к сайту (Шаблон будет установлен в подпапку /b2bcabinet/)';
...
$MESS["WIZARD_THEME_1"] = 'Темная тема (основное меню сбоку)';
$MESS["WIZARD_THEME_2"] = 'Светлая тема (основное меню сверху)';
$MESS["WIZARD_YES"] = 'Да';
$MESS["WIZARD_NO"] = 'Нет';
...
$MESS["WIZARD_SELECT_THEME"] = 'Выбор темы';
...
$MESS["wiz_settings_theme_error"] = 'Не выбран вариант темы';
