            ...
            <div class="tab-pane fade <?= $activeTab == 'desktop' ? 'active show' : '' ?>" id="desktop">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "G_BUYERS_SEF_FOLDER" => SITE_DIR . "personal",
                ...
                <div class="tab-pane fade <?= $activeTab == 'settings' ? 'active show' : '' ?>" id="settings">
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "BUYER_PERSONAL_TYPE" => unserialize(COption::GetOptionString("sotbit.b2bcabinet","BUYER_PERSONAL_TYPE","a:0:{}",SITE_ID), ['allowed_classes' => false]),
