...
$APPLICATION->AddChainItem(Loc::getMessage('B2B_CABINET_ORDERS_ORDER_STATUS'), SITE_DIR . 'b2bcabinet/orders/');
...
if (Loader::includeModule('sotbit.auth') && defined("EXTENDED_VERSION_COMPANIES") && EXTENDED_VERSION_COMPANIES == "Y") {
    ...
    <? $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "PATH_TO_BASKET" => "/b2bcabinet/orders/make/",
            "PATH_TO_CATALOG" => "/b2bcabinet/orders/blank_zakaza/",
            "PATH_TO_PAYMENT" => "/b2bcabinet/orders/payment/",
            "PROP_1" => array(),
            "PROP_2" => array(
                0 => "33",
            ),
