...
<tbody class="blank-zakaza__item" id="<?=$itemIds['ID']?>" data-entity="items-row">
    <tr class="product">
    ...
    <? } ?>
                ...
                default:
                    if($propertyCode != 'BREND_ATTR_S'){
                        ...
                        ?>
                        <td
                                class="product__property product__property--default 43"
                                title='<?= $value ?>'>
                            <?= $value ?>
                        </td>
                    <?}
...
?>
    ...
    const allCounters = document.querySelectorAll('.bootstrap-touchspin');
    ...
    allCounters.forEach(counter => {
        ...
        btnPlus?.addEventListener('click', () => setTimeout(updateState, 100));
        btnMinus?.addEventListener('click', () => setTimeout(updateState, 100));
