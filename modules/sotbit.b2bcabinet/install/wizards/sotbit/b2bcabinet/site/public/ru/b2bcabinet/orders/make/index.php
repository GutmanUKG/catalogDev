...
$stylePath = Option::get('sotbit.b2bcabinet', 'HEADER_TYPE', '1');
...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . sprintf('/assets/css/basket-upselling/%s.css', $stylePath));
...
<main class="basket-page">
    ...
    <footer class="basket-page__footer" id="basket-page__footer">
        <div class="basket-page__action-btn" data-entity="page-basket-action-button">
            ...
            <div class="dropdown-menu">
                ...
                <? if (Loader::includeModule('sotbit.offerlist') && SotbitOfferlist::getModuleEnable()): ?>
                    <span id="offerlist_pricelist_open" class="dropdown-item">
                        <?= Loc::getMessage('BASKET_BTN_ADD_PRICELIST') ?>
                    </span>
                    <span id="offerlist_requestadd_open" class="dropdown-item">
        ...
        <div class="basket-page__checkout-btn" data-entity="page-basket-checkout-button">
            <button class="btn btn_b2b"><?= Loc::getMessage('CHECKOUT_ORDER') ?></button>
        </div>
    </footer>
</main>
...
<? if (Loader::includeModule('sotbit.offerlist') && SotbitOfferlist::getModuleEnable()):
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'DETAIL_PAGE_URL' => SITE_DIR . 'b2bcabinet/offers/pricelist/?ID=#ID#',
        ), false
    );
