...
?>
    <div class="navbar navbar-expand-lg navbar-light navbar-b2b-mainpage">
        <div class="text-center d-lg-none w-100">
            <button type="button" class="navbar-toggler dropdown-toggle collapsed" data-toggle="collapse"
                    data-target="#navbar-second" aria-expanded="false">
                <i class="icon-menu7 mr-2"></i>
                <?= Loc::getMessage("B2B_CABINET_NAVIGATION_PROFILE") ?>
            </button>
        </div>
        <div class="navbar-collapse collapse" id="navbar-second">
            <ul class="nav navbar-nav navbar-mainpage-tabs">
                <? foreach ($arNavBarTabs as $tab): ?>
                    <li class="nav-item">
                        <a href="#<?= $tab["LINK"] ?>"
                           class="navbar-nav-link
                           <?= $tab["LINK"] == $activeTab ? "active" : "" ?>
                           <?= ($tab["CHECK_RIGHTS"] == "Y" && !$USER->IsAuthorized()) ? "disabled" : "" ?>" data-toggle="tab">
            ...
            <? if (defined("EXTENDED_VERSION_COMPANIES") && EXTENDED_VERSION_COMPANIES === 'Y' && Option::get("sotbit.b2bcabinet", "HEADER_TYPE", "1") != 1): ?>
                <ul class="navbar-nav ml-lg-auto b2b-company-choose">
                    <?
                    $APPLICATION->IncludeComponent(
                ...
                <div class="tab-pane fade <?= $activeTab == 'desktop' ? 'active show' : '' ?>" id="desktop">
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "G_BUYORDER_PATH_TO_ORDER_DETAIL" => SITE_DIR . "b2bcabinet/orders/detail/#ID#/",
                            ...
                            "G_ORDERS_PATH_TO_ORDER_DETAIL" => SITE_DIR . "b2bcabinet/orders/detail/#ID#/",
                            ...
                            "G_BUYERS_SEF_FOLDER" => "/b2bcabinet/personal",
                    ...
                    <div class="tab-pane fade <?= $activeTab == 'settings' ? 'active show' : '' ?>" id="settings">
                        ...
                        $APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "BUYER_PERSONAL_TYPE" => unserialize(COption::GetOptionString("sotbit.b2bcabinet",
                                    "BUYER_PERSONAL_TYPE", "a:0:{}", SITE_ID), ['allowed_classes' => false]),
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const navbarItems = document.querySelectorAll('.navbar-b2b-mainpage .navbar-mainpage-tabs .navbar-nav-link:not(.disabled)');
