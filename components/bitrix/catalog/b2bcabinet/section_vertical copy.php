...
<div id="card__catalog__section-wrapper" class="catalog__section-wrapper <?if($session['FULLSCREEN'] == "Y"):?>card-fullscreen<?endif;?>">
    ...
    <section class="catalog__footer card-position-sticky">
        ...
        <img src="/local/templates/b2bcabinet_v2.0/assets/images/info-3.png" class="info-ico-mob" >
	...
	false
            ...
            <?if($USER->IsAdmin()):?>
                <div class="catalog__footer-info">
                    <div class="catalog__footer-info-row-top">
                        ...
                        <div class="catalog__footer-info-item">
                            <div class="catalog__footer-info-ico-container">
                                <img src="/local/templates/b2bcabinet_v2.0/assets/images/boxman3.png" id="ico-boxman" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Вес и объем заказа позволяют осуществить доставку заказа вручную.">
                                <img src="/local/templates/b2bcabinet_v2.0/assets/images/car4.png" id="ico-auto-passenger" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Заказ поместится в багажник легкового автомобиля.">
                                <div class="truck-container truckb">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-big.png" class="truck-b" id="ico-auto-cargo-big" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="">
                                    <!-- <span class="truck-number" id="truck-big-number">0%</span> -->
                                </div>
                                <div class="truck-container truckm">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck111.png" class="truck-m" id="ico-auto-cargo-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="">
                                    <!-- <span class="truck-number" id="truck-medium-number">0%</span> -->
                                </div>
                                <div class="truck-container trucks">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-small.png" class="truck-s" id="ico-auto-cargo-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="">
                                    <!-- <span class="truck-number" id="truck-small-number">0%</span> -->
                                    
                                    
                                </div>
                                <img src="/local/templates/b2bcabinet_v2.0/assets/images/info-3.png" class="info-ico"  style="width: 35px; position: relative; margin-left: 55px; top: -1%">
                            </div>
                        </div>
...
<!-- <script>
    $(document).ready(function(){
        if($.cookie('fullscreen') != 'on') {
            $('.catalog__section-wrapper').removeClass('card-fullscreen').removeClass('m-0').removeClass('h-100');
        }
        setTimeout(() => {
