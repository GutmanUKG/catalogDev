            ...
            success: function(data) {
                if (typeof data.WEIGHT === "undefined" || typeof data.VOLUME === "undefined" || typeof data.QUANTITY === "undefined") {
                    ...
                    if (data.WEIGHT < 23 && data.VOLUME < 0.15) {
                        imageHtml = `<img src="/local/templates/b2bcabinet_v2.0/assets/images/boxman3.png" id="ico-boxman" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Вес и объем заказа позволяют осуществить доставку заказа вручную.">`;
                    } else if ((data.WEIGHT >= 23 || data.VOLUME >= 0.15) && data.VOLUME < 0.5) {
                        imageHtml = `<img src="/local/templates/b2bcabinet_v2.0/assets/images/car4.png" id="ico-auto-passenger" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Заказ поместится в багажник легкового автомобиля.">`;
                    } else if (parseFloat(truckSmallPercent) <= 100 && data.VOLUME > 0.5 ) {
                        imageHtml = `<img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-small.png" class="truck-s" id="ico-auto-cargo-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Доставка возможна малотоннажным грузовиком.">`;
                    } else if (parseFloat(truckSmallPercent) > 100 && parseFloat(truckMediumPercent) <= 100) {
                        imageHtml = `<img src="/local/templates/b2bcabinet_v2.0/assets/images/truck111.png" class="truck-m" id="ico-auto-cargo-m" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Необходим среднетоннажный грузовик.">`;
                    } else if (parseFloat(truckSmallPercent) > 100 && parseFloat(truckMediumPercent) > 100) {
                        imageHtml = `<img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-big.png" class="truck-b" id="ico-auto-cargo-big" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Для доставки требуется еврофура.">`;
                    }
                    ...
                    if (isMobile() || (data.VOLUME > 0.5 && !isMobile())) {
                        ...
                        <div class="info-mobil">
                            ...
                            <div class="catalog__footer-row">
                                <div class="catalog__footer-info-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Вес">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/weight.png" style="margin-right: 10px;" width="25px;">
                                ...
                                <div class="catalog__footer-info-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Объём">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/cube.png" style="margin-right: 10px;" width="25px">
                            ...
                            <div class="catalog__footer-row">
                                <div class="catalog__footer-info-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-black" data-bs-placement="top" title="Общее количество коробок">
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/boxes.png" style="margin-right: 10px;" width="25px">
                            ...
                            <div class="linecar">
                                <div >
                                    ...
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-small.png" width="50px">
                                </div>
                                <div>
                                    Грузовик 5т 25м³
                                    <span>${truckMediumValue} / 100%</span>
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck111.png" width="50px">
                                </div>
                                <div >
                                    Еврофура 20т 90м³
                                    <span>${truckBigValue} / 100%</span>
                                    <img src="/local/templates/b2bcabinet_v2.0/assets/images/truck-big.png" width="70px">
                                </div>
                            </div>
                        ...
                        // Для desktop
                        $('.catalog__footer-info-ico-container, .info-ico-mob').each(function () {
