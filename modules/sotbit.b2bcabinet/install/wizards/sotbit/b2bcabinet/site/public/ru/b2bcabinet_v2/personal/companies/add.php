...
else
{
    ...
    $needProfiles = unserialize(Option::get('sotbit.b2bcabinet', 'BUYER_PERSONAL_TYPE', '', SITE_ID), ['allowed_classes' => false]);
    ...
    $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "PATH_TO_LIST" => SITE_DIR . "b2bcabinet/personal/companies/",
            "SET_TITLE" => "N",
