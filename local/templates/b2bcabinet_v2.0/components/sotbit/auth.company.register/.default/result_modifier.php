...
foreach ($_groups as $group) {
    $_fields[$group] = unserialize(Option::get(SotbitAuth::idModule, 'GROUP_FIELDS_' . $group, '', SITE_ID), ['allowed_classes' => false]);
    $_registerFieldsRequired[$group] = unserialize(Option::get(SotbitAuth::idModule, 'GROUP_REQUIRED_FIELDS_' . $group, '', SITE_ID), ['allowed_classes' => false]);
    $_userFields[$group] = unserialize(Option::get(SotbitAuth::idModule, 'USER_DOP_FIELDS_' . $group, '', SITE_ID), ['allowed_classes' => false]);
    $dbOrderOptFields = unserialize(Option::get(SotbitAuth::idModule, 'GROUP_ORDER_FIELDS_' . $group, '', SITE_ID), ['allowed_classes' => false]);
