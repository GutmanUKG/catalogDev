...
<div class="staff_wrapper">
    ...
    <? if($arResult["IS_ADMIN"] || !empty($arResult['CONFIRM_Y']['ROWS'])): ?>
        <div class="card card-position-sticky">
            <div class="card-body d-flex align-items-center gap-custom-1">
                <?if($arResult["IS_ADMIN"]):?>
                    <button id="staff-list__add-staff" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-staff-register">
