...
document.addEventListener('DOMContentLoaded', ()=>{
	const filterWrapper = document.querySelector('.smart-filter'),
		btnToggle = document.querySelector('.btn_filter'),
		closeFilter = filterWrapper.querySelector('.close_btn')
	btnToggle.addEventListener('click', ()=>{
		filterWrapper.classList.add('mobile_filter')
		document.body.style.overflow = 'hidden'
	})
	closeFilter.addEventListener('click', ()=>{
		filterWrapper.classList.remove('mobile_filter')
