                ...
                case 'QUANTITY':
                    ...
                    <?} else {?>
                        ...
                        if (!$isOffers || ($arParams['OFFERS_VIEW'] != 'LIST' && $isOffers)) {
                            ...
                            ?>
                                <?if($item['ACTUAL_QUANTITY'] < 1):?>
                            <button data-id="<?= $itemIds['QUANTITY'] ?>" class="btn btn-primary basket-item--add">В Корзину</button>
                            <?endif;?>
                            <div class="bootstrap-touchspin input-group" id="<?= $itemIds['QUANTITY'] ?>" data-entity="quantity-block"
                                <?if($item['ACTUAL_QUANTITY'] < 1):?> style="display: none" <?endif;?>
                            >
