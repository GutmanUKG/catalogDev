    ...
    function InitStep()
    {
        ...
        $wizard->SetDefaultVars(
            Array(
                ...
                "shopINN" => COption::GetOptionString("b2bcabinet", "shopINN", "", $siteID),
                // "shopKPP" => COption::GetOptionString("b2bcabinet", "shopKPP", "123456789", $siteID),
                "shopKPP" => COption::GetOptionString("b2bcabinet", "shopKPP", "", $siteID),
                // "shopNS" => COption::GetOptionString("b2bcabinet", "shopNS", "0000 0000 0000 0000 0000", $siteID),
                "shopNS" => COption::GetOptionString("b2bcabinet", "shopNS", "", $siteID),
                ...
                "shopKS" => COption::GetOptionString("b2bcabinet", "shopKS", "", $siteID),
...
class DataCollection extends CWizardStep
{
    ...
    function OnPostForm()
    {
        ...
        if(!empty($dataCollection['Email']) && !empty($dataCollection['Name']) && !empty($dataCollection['Phone']) && !empty($dataCollection['Site']))
        {
    ...
    function ShowStep()
    {
        ...
        $this->content .= '
                    <div class="wizard-input-form-block">
						...
						'.$this->ShowInputField('text', 'dataCollection[Site]', array("id" => "dataCollectionSite", "class" => "wizard-field")).'
					</div>';            
        ...
        $this->content .= '<div class="data-collection-right__personal-manager-name">'.GetMessage("wiz_datacollection_personal_manager").'</div>';
