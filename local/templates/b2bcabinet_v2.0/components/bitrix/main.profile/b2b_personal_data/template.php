                ...
                <div class="collapse show">
                    <div class="card-body">
                        <div class="form-group-flex">
                            <?
                            list(
                                $arResult['MAIN_DATA']['TITLE'],
                                $arResult['MAIN_DATA']['NAME'],
                                $arResult['MAIN_DATA']['LAST_NAME'],
                                $arResult['MAIN_DATA']['SECOND_NAME'],
                                $arResult['MAIN_DATA']['EMAIL'],
                                $arResult['MAIN_DATA']['NEW_PASSWORD'],
                                $arResult['MAIN_DATA']['NEW_PASSWNEW_PASSWORD_CONFIRMORD'],
                            ...
                            ?>
                            <div class="form-group-wrap" data-name="<?=$mData['NAME']?>">
                                <?
