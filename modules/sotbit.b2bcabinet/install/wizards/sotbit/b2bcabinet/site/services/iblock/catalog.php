...
//catalog iblock import
    ...
    $methodInstall = Option::get($moduleName,'method_install', '', WIZARD_SITE_ID);
    $catalogXML = $methodInstall == 'AS_TEMPLATE' ? "/catalog.xml" : "/catalog_site.xml";
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID.$catalogXML;
