...
$iblockType = "sotbit_b2bcabinet_content";

$iblockCode = 'sotbit_b2bcabinet_banners';
...
Option::set($moduleId, 'BANNERS_IBLOCKS_ID', $iblockID, WIZARD_SITE_ID);
Option::set($moduleId, 'BANNERS_IBLOCKS_TYPE', $iblockType, WIZARD_SITE_ID);
?><?php
