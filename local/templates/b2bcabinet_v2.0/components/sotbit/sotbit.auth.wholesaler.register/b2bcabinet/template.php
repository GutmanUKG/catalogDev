...
$userFields = $USER_FIELD_MANAGER->GetUserFields("USER", 0, LANGUAGE_ID);
                        ...
                        <? if (isset($arResult['OPT_ORDER_FIELDS'][$group['ID']]) && !empty($arResult['OPT_ORDER_FIELDS'][$group['ID']])): ?>
                            <div class="mb-4">
                                ...
                                <div class="row">
                                                                ...
                                                                <div class="form-control-multiple-wrap">
                                                                    ...
                                                                    <?if ($key !== 0): ?>
                                                                        <div class="form-control-multiple position-absolute end-0 top-50 translate-middle-y me-1" 
                                                                            ...
                                                                            <button 
                                                                                class="form-control-multiple-ic btn btn-sm btn-icon btn-link" 
                                                                                type="button">
                                                                                    <i class="ph-x"></i>
                                                                            </button>
                                                                        </div>
                                    ...
                                    if (isset($userFields['UF_URADRESS']) && is_array($userFields['UF_URADRESS'])) {
                                        $userFields['UF_URADRESS']['VALUE'] = $arResult['VALUES']['UF_URADRESS'] ?? '';
                                        ?>
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text"
                                                       class="form-control"
                                                       name="REGISTER[UF_URADRESS]"
                                                       value="<?=htmlspecialcharsbx($arResult['VALUES']['UF_URADRESS'] ?? '')?>"
                                    ...
                                    ?>
                                    <?php
                                    if (in_array('PERSONAL_ZIP', $arResult["SHOW_FIELDS"])): ?>
                                        <div class="col-md-12 mb-2">
                                            <label class="form-label"><?= GetMessage("REGISTER_FIELD_PERSONAL_ZIP") ?>:</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text"
                                                       class="form-control"
                                                       name="REGISTER[PERSONAL_ZIP]"
                                                       value="<?= htmlspecialcharsbx($arResult['VALUES']['PERSONAL_ZIP'] ?? '') ?>"
                                                       placeholder="<?= GetMessage("REGISTER_PLACEHOLDER_PERSONAL_ZIP") ?>">
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <?php
                                   // if (in_array('WORK_STREET', $arResult["WORK_STREET"])): ?>
                                        <div class="col-md-12 mb-2">
                                            <label class="form-label"><?= GetMessage("ADRESS") ?>:</label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                                <input type="text"
                                                       class="form-control"
                                                       name="REGISTER[WORK_STREET]"
                                                       value="<?= htmlspecialcharsbx($arResult['VALUES']['WORK_STREET'] ?? '') ?>"
                                                       placeholder="<?= GetMessage("ADRESS") ?>">
                                            </div>
                                        </div>
                                    <?//php endif; */?>
...
<script>
    ...
    var ffff = '<?=$arResult["AGREEMENT_INPUT_NAME"]?>';
</script>