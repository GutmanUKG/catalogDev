        ...
        <div class="tab-pane fade show active" id="basic-tab1">
            <div class="blank_detail_table">
                ...
                if(strlen($arResult["ID"])>0)
                {
                    ...
                    ?>
                    <form method="post" id="form_org_edit" class="col-md-12 sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
                        <?=bitrix_sessid_post()?>
                                            ...
                                            <div class="collapse show">
                                                <div class="card-body">
                                                    ...
                                                    foreach($block["PROPS"] as $property)
                                                    {
                                                        ...
                                                        ?>
                                                            <?if($name  == 'ORDER_PROP_21') continue;?>
                                                            ...
                                                            elseif ($property["TYPE"] == "TEXT"  || $property["TYPE"] == "NUMBER")
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    <input
                                                                            ...
                                                                            maxlength="50"
                                                                            id="sppd-property-<?=$key?>"
                                                                            value="<?=!empty($currentValue) ? $currentValue : $_POST[$name]?>"/>
                                                                    <?
                                                                }
                                                            }
...
<script>
    $(document).ready(function(){
        $('input[name="ORDER_PROP_4"]').attr('required', 'required');
        $('input[name="ORDER_PROP_16"]').attr('required', 'required');
