                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            ...
                            <div class="bzd-markdown-item__article"><?=Loc::getMessage('CT_BZD_MARKDOWN_ARTICLE')?>: <?=$arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']?></div>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="bzd-markdown-wrapper">
                            <div class="bzd-markdown-aside">
                                <div id="<?=$markdownCarouselId?>" class="carousel slide" data-bs-ride="carousel" data-bs-touch="true" data-bs-interval="60000">
                                    <?if($arResult['PROPERTIES']['MORE_PHOTO']['VALUE']):?>
                                        <div class="carousel-indicators">
                                            <button type="button" data-bs-target="#<?=$markdownCarouselId?>" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 0"></button>
                                            <?foreach($arResult['PROPERTIES']['MORE_PHOTO']['VALUE'] as $key => $pict):?>
                                                <?$pictSrc = CFile::GetPath($pict);?>
                                                <?if($pictSrc != $arResult['DETAIL_PICTURE']["SRC"]):?>
                                                    <button type="button" data-bs-target="#<?=$markdownCarouselId?>" data-bs-slide-to="<?=$key+1?>" aria-label="Slide <?=$key+1?>"></button>
                                                <?endif;?>
                                            <?endforeach;?>
                                        </div>
                                    <?endif;?>
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="blank-zakaza-detail__image-wrapper">
                                                <img class="blank-zakaza-detail__image" src="<?=$arResult['DETAIL_PICTURE']["SRC"]?>" title="<?=$title?>" alt="<?=$alt?>">
                                            </div>
                                        </div>
                                        <?if($arResult['PROPERTIES']['MORE_PHOTO']['VALUE']):?>
                                            <?foreach($arResult['PROPERTIES']['MORE_PHOTO']['VALUE'] as $key => $pict):?>
                                    ...
                                    <?if($arResult['PROPERTIES']['MORE_PHOTO']['VALUE']):?>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#<?=$markdownCarouselId?>" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#<?=$markdownCarouselId?>" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                        </button>
                                    <?endif;?>
                                </div>
