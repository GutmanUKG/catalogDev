...
<script>
    document.addEventListener('DOMContentLoaded',()=>{
        let collapseBtns = document.querySelectorAll('.bx_filter_parameters_box_collapse_btn');
        collapseBtns.forEach(i=>{
            i.addEventListener('click', ()=>{
                if(i.classList.contains('collapsed')){
                    i.textContent = 'Показать ещё'
                }else{
                    i.textContent = 'Скрыть'
                }
            })
        })
        // let bx_filter_section = document.querySelector('.bx_filter_section .card-body')
        // bx_filter_section.style.height = document.body.clientHeight + 'px'
