...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PAGE_URL" => "N",
		"IMAGE_SIZE_DELIVERY_PAYSYSTEM" => array(
			0 => "23",
			1 => "23",
		),
		"PRODUCT_COLUMNS_VISIBLE" => array(0=> ""
		),
		...
		"PATH_TO_PAYMENT" => SITE_DIR."b2bcabinet/orders/payment/index.php",
		"PATH_TO_PERSONAL" => SITE_DIR."b2bcabinet/orders/index.php",
		"PAY_FROM_ACCOUNT" => "Y",
